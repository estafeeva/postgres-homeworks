...
SELECT country, COUNT(*) AS item FROM suppliers GROUP BY country ORDER BY item DESC
...
SELECT ship_country, SUM (freight) AS item FROM orders WHERE ship_region IS NOT NULL
